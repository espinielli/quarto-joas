...
author:
  - name: First Author
    corresponding: true
    email: correspndence@email.domain
    affiliations:
      - name: Institution-1
        city: City-1
        country: Country-1
  - name: Second Author
    affiliations:
      - name: Institution-2
        ...
        country: Country-2
  - name: Third Author
    email: correspndence2@email.domain
    affiliations:
      - name: Institution-3
        city: City-3
        country: Country-3
...
![JOAS Logo](_extensions/quarto-journals/joas/extra/joas-logo.pdf){#fig-logo width=60% fig-align="center"}
