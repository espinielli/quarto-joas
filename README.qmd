...
fs::dir_copy("_extensions/joas/media", "media",overwrite = TRUE)
fs::file_copy("_extensions/joas/media/joas.cls", "joas.cls",overwrite = TRUE)
fs::file_copy("_extensions/joas/references.bib", "references.bib",overwrite = TRUE)
